...
const PortfolioOutput = () => (
  ...
  <a href="https://www.linkedin.com/in/jamiegodwin/" target="_blank" rel="noopener noreferrer">
    <FontAwesomeIcon icon={faLinkedin} className="font-awesome-icon" />
      ...
      <br />
      <li>I played key roles in two startups selected for the<strong>Google Launchpad Accelerator programme</strong>. CTO at <a href="https://Jumo.world" target="_blank" rel="noopener noreferrer">Jumo.world</a> and CXO & founder at <a href="https://www.swiftvee.com/" target="_blank" rel="noopener noreferrer">swiftvee.com</a></li>
    </ul>
